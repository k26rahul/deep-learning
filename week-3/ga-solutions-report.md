...
*   **Activation functions**:
    ...
    *   **Softmax**: $\mathrm{softmax}(z)_i = \frac{e^{z_i}}{\sum_j e^{z_j}}$
...
$$W_1 x = \begin{bmatrix} 0.5488135(1) + 0.71518937(0) + 0.60276338(1) \\ 0.54488318(1) + 0.4236548(0) + 0.64589411(1) \\ 0.43758721(1) + 0.891773(0) + 0.96366276(1) \end{bmatrix} = \begin{bmatrix} 1.15157688 \\ 1.19077729 \\ 1.40124997 \end{bmatrix}$$
...
$$\mathrm{Sum}(a_1) = 1.5350184 + 1.98250233 + 1.93014489 = 5.4477$$
...
$$\mathrm{Sum}(h_1) = 0.82273938 + 0.87894766 + 0.87326546 = 2.57495$$
...
1.  **Pre-activations**: $a_2 = W_2 h_1 + b_2$
    ...
    $$a_2 = \begin{bmatrix} 2.10091008 \\ 1.76019958 \\ 2.59905711 \end{bmatrix} \Rightarrow \mathrm{Sum}(a_2) = 6.46$$

2.  **Post-activations**: $h_2 = \sigma(a_2)$
    $$h_2 = \begin{bmatrix} 0.89099238 \\ 0.85324546 \\ 0.9308477 \end{bmatrix} \Rightarrow \mathrm{Sum}(h_2) = 2.63$$

### Output Layer Calculations
1.  **Pre-activations**: $a_3 = W_3 h_2 + b_3$
    $$a_3 = \begin{bmatrix} 1.34960588 \\ 1.70564619 \\ 1.81966891 \end{bmatrix} \Rightarrow \mathrm{Sum}(a_3) = 4.87$$

2.  **Softmax predictions**: $\hat{y} = \mathrm{softmax}(a_3)$
...
*   **Answer**: **Option E** $\left[ 0.23, 0.33, -0.57 \right]^T$
...
*   **Answer**: **Option A** $\left[ 0.018, -0.019, -0.003 \right]^T$
...
*   $W_{\mathrm{layer,new}} = W_{\mathrm{layer}} - \nabla_{W_{\mathrm{layer}}} L$
*   $b_{\mathrm{layer,new}} = b_{\mathrm{layer}} - \nabla_{b_{\mathrm{layer}}} L$

### New Forward Pass and Loss
Propagating the input $x = [1, 0, 1]^T$ through the network with updated parameters yields:
1.  **Layer 1 new**: 
    $$a_{1,\mathrm{new}} = \begin{bmatrix} 1.62479 \\ 2.08027 \\ 2.01529 \end{bmatrix} \Rightarrow h_{1,\mathrm{new}} = \begin{bmatrix} 0.83546 \\ 0.88898 \\ 0.88237 \end{bmatrix}$$

2.  **Layer 2 new**: 
    $$a_{2,\mathrm{new}} = \begin{bmatrix} 2.11589 \\ 1.74542 \\ 2.59560 \end{bmatrix} \Rightarrow h_{2,\mathrm{new}} = \begin{bmatrix} 0.89246 \\ 0.85137 \\ 0.93060 \end{bmatrix}$$

3.  **Layer 3 new**: 
    $$a_{3,\mathrm{new}} = \begin{bmatrix} 1.13854 \\ 1.41743 \\ 4.09204 \end{bmatrix} \Rightarrow \hat{y}_{\mathrm{new}} = \begin{bmatrix} 0.048383 \\ 0.063943 \\ 0.897674 \end{bmatrix}$$

### New Cross-Entropy Loss
$$L_{\mathrm{new}} = -\ln(\hat{y}_{3,\mathrm{new}}) = -\ln(0.897674) = 0.072533$$
